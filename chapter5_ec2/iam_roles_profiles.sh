...
# Vi enter :set paste (and then i to enter insert mode) to avoid adding unnecessary spaces and hashes.
...
aws ec2 associate-iam-instance-profile --instance-id <LAB_WEB_SERVER_INSTANCE_ID> --iam-instance-profile 
Name="DEV_PROFILE"
